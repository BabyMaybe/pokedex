    ...
    return (
        <div className="move-body move-screen screen">
            <div className="move-left">
                ...
                <div className="move-stat">Accuracy.....100</div>
                <div className="move-stat">Power.........80</div>
                <div className="move-stat">PP............10</div>
            </div>
            <div className="move-right">
                <div className="move-type">Type: Normal</div>
                <div className="move-learn">Learn: Lvl 100</div>
                <div className="move-status">Status Effect: Freeze</div>
            </div>
        </div>
    );
}
